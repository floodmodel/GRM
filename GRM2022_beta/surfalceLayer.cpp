...
//void setCurLAIRatio() {
//	double laiRatio_cur = 0.0;
//	switch (ts.tCurMonth) {
//	case 1:
//		if (ts.tCurDay < 16) {
//			laiRatio_cur = laiRatio[1011];
//		}
//		else {
//			laiRatio_cur = laiRatio[1012];
//		}
//		break;
//	case 2:
//		if (ts.tCurDay < 16) {
//			laiRatio_cur = laiRatio[1021];
//		}
//		else {
//			laiRatio_cur = laiRatio[1022];
//		}
//		break;
//	case 3:
//		if (ts.tCurDay < 16) {
//			laiRatio_cur = laiRatio[1031];
//		}
//		else {
//			laiRatio_cur = laiRatio[1032];
//		}
//		break;
//	case 4:
//		if (ts.tCurDay < 16) {
//			laiRatio_cur = laiRatio[1041];
//		}
//		else {
//			laiRatio_cur = laiRatio[1042];
//		}
//		break;
//	case 5:
//		if (ts.tCurDay < 16) {
//			laiRatio_cur = laiRatio[1051];
//		}
//		else {
//			laiRatio_cur = laiRatio[1052];
//		}
//		break;
//	case 6:
//		if (ts.tCurDay < 16) {
//			laiRatio_cur = laiRatio[1061];
//		}
//		else {
//			laiRatio_cur = laiRatio[1062];
//		}
//		break;
//	case 7:
//		if (ts.tCurDay < 16) {
//			laiRatio_cur = laiRatio[1071];
//		}
//		else {
//			laiRatio_cur = laiRatio[1072];
//		}
//		break;
//	case 8:
//		if (ts.tCurDay < 16) {
//			laiRatio_cur = laiRatio[1081];
//		}
//		else {
//			laiRatio_cur = laiRatio[1082];
//		}
//		break;
//	case 9:
//		if (ts.tCurDay < 16) {
//			laiRatio_cur = laiRatio[1091];
//		}
//		else {
//			laiRatio_cur = laiRatio[1092];
//		}
//		break;
//	case 10:
//		if (ts.tCurDay < 16) {
//			laiRatio_cur = laiRatio[1101];
//		}
//		else {
//			laiRatio_cur = laiRatio[1102];
//		}
//		break;
//	case 11:
//		if (ts.tCurDay < 16) {
//			laiRatio_cur = laiRatio[1111];
//		}
//		else {
//			laiRatio_cur = laiRatio[1112];
//		}
//		break;
//	case 12:
//		if (ts.tCurDay < 16) {
//			laiRatio_cur = laiRatio[1121];
//		}
//		else {
//			laiRatio_cur = laiRatio[1122];
//		}
//		break;
//	default:
//		laiRatio_cur = laiRatio[1011];
//	}
//	ts.laiRatioCurDay = laiRatio_cur;
//}