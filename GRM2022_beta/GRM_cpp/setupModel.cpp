...
{
	int isnormal = -1;
	wpSimValue.rfiReadSumUpWS_mPs.clear();
	wpSimValue.rfUpWSAveForDt_mm.clear();
	wpSimValue.rfUpWSAveForPT_mm.clear();
	wpSimValue.rfUpWSAveTotal_mm.clear();
	wpSimValue.rfWPGridForPT_mm.clear();
	wpSimValue.rfWPGridTotal_mm.clear();
